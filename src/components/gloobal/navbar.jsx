    ...
    return (
        <>
            <div className="overflow-hidden">
                <div className="w-full flex items-center justify-between bg-white sticky top-0 px-8 py-2 shadow-md sm:px-2 z-50">
                ...
                <div className={`transition-all w-[280px] h-screen border shadow bg-white absolute ${isShowSidebarSettingMenu ? "right-0" : "right-[-500px]"}`}>
